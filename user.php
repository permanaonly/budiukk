    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="user.php">
                ...
                <div class="sidebar-brand-text mx-3">BudiTrackers</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-secondary topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link-secondary d-md-none rounded-circle mr-3">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 text-white-600 large"><?= $_SESSION['nama'] ?></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="h3  mb-4 text-gray-800">
                        ...
                        if (!empty(@$_GET['url'])) {
                            ...
                            echo "<h1>Selamat Datang di Megamex</h1>";
                            echo "<h3>Aplikasi untuk Mencatat Riwayat Perjalanan Anda</h3>";
                        }
                        ?>
                    </div>
